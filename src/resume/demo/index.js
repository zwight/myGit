...
//下载源代码
	$('.demo_box_link_JD').click(function(){
    	window.location.href="http://www.zwight.net/resume/demo/JD.zip";
	})
	$('.demo_box_link_IWIN').click(function(){
    	window.location.href="http://www.zwight.net/resume/demo/IWIN.zip";
	})
	$('.demo_box_link_lailiao').click(function(){
    	window.location.href="http://www.zwight.net/resume/demo/lailiao.zip";
	})
	$('.demo_box_link_NetEase').click(function(){
    	window.location.href="http://www.zwight.net/resume/demo/NetEase.zip";
	})